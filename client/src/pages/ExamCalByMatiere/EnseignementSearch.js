 ...
 */
  function handleCourseClick(course) {
    ...
    setcodeenseignant(course.intitule)
  }
...
return <Calendar nameMatiere={codeenseignant}/>
  ...
  return (
    <div className="course-wrapper">
       <h1>Liste des Examan par matiere</h1>
      ...
      const classRepresentation = `${val.intitule} ${val.coeff}`.toLowerCase();
